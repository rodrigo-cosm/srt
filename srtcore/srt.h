...
// Field names assigned to type
#define SRTMF_INT i
#define SRTMF_LONG ll
#define SRTMF_ULONG ull
#define SRTMF_DOUBLE d
...
struct SrtStatsCell
{
    ...
    enum SrtStatsTypes type;
};

typedef struct SrtStatsCell SRT_STATS;

// HERE INJECTED GENERATED PART
// Generated by generate-stats-fields.tcl
...
enum SrtStatsKey
{
    ...
    SRTM_SND_BYTE_BUF,
    SRTM_SND_MS_BUF,
    SRTM_SND_BYTE_AVAIL_BUF,
    SRTM_SND_PKT_BUF_AVG,
    SRTM_SND_BYTE_BUF_AVG,
    SRTM_SND_MS_BUF_AVG,
    SRTM_SND_BYTE_AVAIL_BUF_AVG,
    SRTM_SND_MS_LATENCY,
    SRTM_RCV_PKT_BUF,
    SRTM_RCV_BYTE_BUF,
    SRTM_RCV_MS_BUF,
    SRTM_RCV_BYTE_AVAIL_BUF,
    SRTM_RCV_PKT_BUF_AVG,
    SRTM_RCV_BYTE_BUF_AVG,
    SRTM_RCV_MS_BUF_AVG,
    SRTM_RCV_BYTE_AVAIL_BUF_AVG,
    SRTM_RCV_MS_LATENCY,
    SRTM_SND_PKT_LOCAL,
    SRTM_SND_PKT_TOTAL,
    SRTM_SND_BYTE_LOCAL,
    SRTM_SND_BYTE_TOTAL,
    SRTM_SND_PKT_LOSS_LOCAL,
    SRTM_SND_PKT_LOSS_TOTAL,
    SRTM_E_SIZE
};
...
#define SRTM_TYPE_TIMESTAMP LONG
#define SRTM_TYPE_SNDPERIOD LONG
#define SRTM_TYPE_WINDOW_FLOW INT
#define SRTM_TYPE_WINDOW_CONG INT
#define SRTM_TYPE_FLIGHTSIZE INT
#define SRTM_TYPE_RTT DOUBLE
#define SRTM_TYPE_BANDWIDTH DOUBLE
#define SRTM_TYPE_MAXBW DOUBLE
#define SRTM_TYPE_MSS INT
#define SRTM_TYPE_RDISTANCE INT
#define SRTM_TYPE_RTOLERANCE INT
#define SRTM_TYPE_SND_PKT_BUF INT
#define SRTM_TYPE_SND_BYTE_BUF INT
#define SRTM_TYPE_SND_MS_BUF INT
#define SRTM_TYPE_SND_BYTE_AVAIL_BUF INT
#define SRTM_TYPE_SND_PKT_BUF_AVG INT
#define SRTM_TYPE_SND_BYTE_BUF_AVG INT
#define SRTM_TYPE_SND_MS_BUF_AVG INT
#define SRTM_TYPE_SND_BYTE_AVAIL_BUF_AVG INT
#define SRTM_TYPE_SND_MS_LATENCY INT
#define SRTM_TYPE_RCV_PKT_BUF INT
#define SRTM_TYPE_RCV_BYTE_BUF INT
#define SRTM_TYPE_RCV_MS_BUF INT
#define SRTM_TYPE_RCV_BYTE_AVAIL_BUF INT
#define SRTM_TYPE_RCV_PKT_BUF_AVG INT
#define SRTM_TYPE_RCV_BYTE_BUF_AVG INT
#define SRTM_TYPE_RCV_MS_BUF_AVG INT
#define SRTM_TYPE_RCV_BYTE_AVAIL_BUF_AVG INT
#define SRTM_TYPE_RCV_MS_LATENCY INT
#define SRTM_TYPE_SND_PKT_LOCAL LONG
#define SRTM_TYPE_SND_PKT_TOTAL LONG
#define SRTM_TYPE_SND_BYTE_LOCAL ULONG
#define SRTM_TYPE_SND_BYTE_TOTAL ULONG
#define SRTM_TYPE_SND_PKT_LOSS_LOCAL INT
#define SRTM_TYPE_SND_PKT_LOSS_TOTAL INT

// END GENERATED SECTION.

static const size_t SRT_STATS_SIZE = (size_t)SRTM_E_SIZE;

// Example usage for a stat with key: SRTM_SNDPERIOD

// Call it this way:
//      sndperiod = SRTM_GET(statsarray, SNDPERIOD);
// (note: no SRTM_ prefix!)
#define SRTM_GET(array, key) SRTM_GET_IN1(array, SRTM_##key, SRTM_TYPE_##key)

// Those below macros are resolving the call into the desired form
// that involves both the key as index for the array and the field
// of the union that returns the value in the right type.

// This will resolve SRTM_TYPE_SNDPERIOD into LONG
#define SRTM_GET_IN1(array, key, typefieldkey) SRTM_GET_IN2(array, key, typefieldkey)

// This will add prefix to form SRTMF_LONG and resolve it into "ll"
#define SRTM_GET_IN2(array, key, typesign) SRTM_GET_IN3(array, key, SRTMF_##typesign)

// Now that typefield is ll, it will resolve into: array[SRTM_SNDPERIOD].ll
#define SRTM_GET_IN3(array, key, typefield) array[key].typefield
...
SRT_API int srt_stats(SRTSOCKET u, SRT_STATS* perf, size_t size, int clear);
